...
namespace pw6
{
    public class convert
    {
        ...
        {
            var putit = File.ReadAllText(Program.FilePath);
        ...
        {
            var x = new XmlSerializer(typeof(List<Class1>));
            using (var fl = new FileStream(Program.FilePath, FileMode.OpenOrCreate))
            {
        ...
        public static List<Class1> FromTXT()
        {
            ...
            {
                string[] str = File.ReadAllLines(Program.FilePath);
